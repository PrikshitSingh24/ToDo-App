...
class _HomeState extends State<Home> {
  ...
  void save_data() {
    List<String> splist=todoslist.map((item) => json.encode(item.toMap())).toList();
    sharedPreferences.setStringList('todoslist', splist);

  }
  void loadData(){
    List<String>? splist =sharedPreferences.getStringList('todoslist');
        ...
        title:Row(
          ...
          children: [
            ...
            Container(
              ...
              width: 60,
              child: ClipRRect(
                child: Image.asset('assets/istockphoto-1210939712-612x612-removebg-preview.png'),
